...
<template>
    <div class="producto">
        ...
        <div class="inputBox">
            <input type="text" required="required" v-model="data.Id" />
            <span>Nombre</span>
        </div>

        <div class="inputBox">
            <input type="text" required="required" v-model="data.Descripcion" />
        ...
        <div class="inputBox">
            <select class="select" v-model="data.Tipo">
        ...
        <div class="inputBox">
            <input type="number" required="required" v-model="data.Minimo"/>
